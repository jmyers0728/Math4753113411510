#' Title
#'
#' @param t0 is the lower quartile point
#' @param xmax maximun density of the graph
#' @param n sample size
#' @param alpha how large of confidence interval
#'
#' @return a list with the value of p
#' @export
#'
#' @examples mypvalue() will print out a graph with the confidence
#' interval set at 95 percent degree of freedom of 19 and max density of
#' 4
